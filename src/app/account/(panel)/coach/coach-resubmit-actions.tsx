...
import { CoachAccountForm, type CoachResubmitData } from "./coach-account-form";

export function CoachResubmitActions({
  reason,
  prefill,
  resubmit,
}: {
  ...
  if (editing) {
    return (
      <div className="mt-3 border-t border-slate-100 pt-4">
        ...
        <CoachAccountForm prefill={prefill} resubmit={resubmit} />
      </div>
    );
  }
