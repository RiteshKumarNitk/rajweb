...
import { SchoolMembershipForm, type SchoolResubmitData } from "./school-membership-form";

export function SchoolResubmitActions({
  reason,
  prefill,
  resubmit,
}: {
  ...
  if (editing) {
    return (
      <div className="mt-3 border-t border-slate-100 pt-4">
        ...
        <SchoolMembershipForm prefill={prefill} resubmit={resubmit} />
      </div>
    );
  }
