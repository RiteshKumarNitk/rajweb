...
export default async function AccountSchoolMembershipPage() {
  ...
  if (membership) {
    ...
    return (
      <div>
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-primary">School Membership Workspace</h1>
          <p className="text-slate-500">Your school membership application and its status.</p>
        </div>
          ...
          <Card className="lg:col-span-2">
            ...
            <CardContent className="space-y-2 text-sm">
              ...
              {membership.studentCount !== null && (
                <p><span className="text-slate-500">Student Count:</span> <span className="font-medium">{membership.studentCount}</span></p>
              )}
