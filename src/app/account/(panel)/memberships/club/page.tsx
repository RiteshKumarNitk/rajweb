...
export default async function AccountClubMembershipPage() {
  ...
  if (membership) {
    ...
    return (
      <div>
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-primary">Club Membership Workspace</h1>
          <p className="text-slate-500">Your club membership application and its status.</p>
        </div>
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          <Card className="lg:col-span-2">
            ...
            <CardContent className="space-y-2 text-sm">
              ...
              <p><span className="text-slate-500">Number of Courts:</span> <span className="font-medium">{membership.numberOfCourts}</span></p>
